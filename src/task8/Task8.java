...
public class Task8 {
    public static void main(String[] args) {
        Footwear wt1 = new Women("Женские кроссовки", "Nike", "Nike1", 5000,"Белый", "Спортивная обувь", "Жен", "Натуральная кожа", 37, "Весна-лето" );
        Footwear mt1 = new Men("Мужские кроссовки", "Adidas", "Adidas1", 7000,"Черный", "Спортивная обувь", "Муж", "Натуральная кожа", 42, "Весна-осень");
