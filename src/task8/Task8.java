...
public class Task8 {
    public static void main(String[] args) {
        Footwear wt1 = new Women("0011","Женские кроссовки", "Nike", "Nike1", 5000,"Белый", "Спортивная обувь", "Жен", "Натуральная кожа", 37, "Весна-лето" );
        Footwear mt1 = new Men("0012", "Мужские кроссовки", "Adidas", "Adidas1", 7000,"Черный", "Спортивная обувь", "Муж", "Натуральная кожа", 42, "Весна-осень");
        Glove gl1 = new Glove("1100","Перчатки", "Reebok",3500,"Синий", "Спортивная одежда", "Унисекс", "Текстиль", "М", "Зима");
